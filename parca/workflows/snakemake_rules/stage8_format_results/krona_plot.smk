...
rule readcount_RNA:
    ...
    script: "../../scripts/reformat_results/readcount_formatting_RNA.R" 
...
rule readcount_DNA:
    ...
    params: 
        mincount=config['krona_plot_min_count']
    script: "../../scripts/reformat_results/readcount_formatting_DNA.R" 
...
rule tableview_SE:
    ...
    output: 
        tableview="{outdir}/{start_date}_{run_id}/snakemake_results_{sample}/SE_{nucleotide}/stage8/readcount_tableview.tsv"
    params:
        SE_or_PE="SE",
...
rule tableview_PE:
    ...
    output: 
        tableview="{outdir}/{start_date}_{run_id}/snakemake_results_{sample}/PE_{nucleotide}/stage8/readcount_tableview.tsv",
        organism_dfs_dir=directory("{outdir}/{start_date}_{run_id}/snakemake_results_{sample}/PE_{nucleotide}/stage8/organism_dfs")
    params:
        SE_or_PE="PE",
        mincount=config['tableview_min_count']
    script: "../../scripts/reformat_results/tableview.R"
